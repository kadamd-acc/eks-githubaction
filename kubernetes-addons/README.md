...
| <a name="input_cert_manager_domain_names"></a> [eks\_cluster\_domains](#input\_eks\_cluster\_domains) | Domain names of the Route53 hosted zone to use with cert-manager. | `list(string)` | `[]` | no |
